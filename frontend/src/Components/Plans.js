    ...
    <div className="plans">
      ...
      <div className="container">
        ...
        <div className="row justify-content-center mt-4">
          ...
          <div className="col-lg-4 d-none col-md-6 advanced-plan mb-5">
            <div className="d-flex card border-0">
              <div className="pricing-card text-align-center">
                <div className="pricing-header2 position-relative">
          ...
          <div className='col-lg-4 newPlan mb-4 mb-lg-0'>
            <div className='card  '>
              <div className='card-body text-start'>
                <h2 className='mb-3'>Basic</h2>
                <h3 className='mb-4'><sup>$</sup>199<span>/month</span></h3>

                <ul className='p-0'>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Min. Contract 4 Months</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Local & National SEO</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Minimum 8 Keywords</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Business Analysis</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>In-depth Website Study</li>
                </ul>

                <Link to='/contact' className='btn btn-purple'>Get in touch</Link>
              </div>
          ...
          <div className='col-lg-4 newPlan mb-4 mb-lg-0'>
            <div className='card position-relative '>
              ...
              <div className='card-body text-start'>
                <h2 className='mb-3'>Standard</h2>
                <h3 className='mb-4'><sup>$</sup>299<span>/month</span></h3>

                <ul className='p-0'>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Min. Contract 6 Months</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Local & National,International SEO</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Minimum 20 Keywords</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Business Analysis</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>In-depth Website Study</li>
                </ul>
          ...
          <div className='col-lg-4 newPlan mb-4 mb-lg-0'>
            <div className='card  '>
              <div className='card-body text-start'>
                ...
                <h3 className='mb-4'><sup>$</sup>399<span>/month</span></h3>

                <ul className='p-0'>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Min. Contract 12 Months</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Local & National,International SEO</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Minimum 20 Keywords</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>Business Analysis</li>
                  <li className="ami-price"><i className="fa-solid fa-check-circle me-2"></i>In-depth Website Study</li>
