        ...
        const fetchServiceContent = async () => {
            ...
            try {
                const response = await fetch(
                    `${BASE_URL}/single-service/slug/branding`
                );
                if (!response.ok) {
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            },
            {
                ...
                position: 3,
                name: "Branding",
                item: "https://whitehatseo.in/services/branding",
            },
        ],
    };
        ...
        <>
            ...
            <div className="service_single">
                                ...
                                <div className="row align-items-center">
                                    <div className="col-lg-7 position-relative text-start">
                                        <h1 className="hero-title mb-4 text-start">
                                            Strategic <span>Branding Services</span> That Build Trust,
                                        ...
                                        <p className="m-0">
                                            ...
                                            online and offline channels. From brand positioning and storytelling to
                                            visual design and digital presence, we craft brands that inspire trust,
                                            build credibility, and leave a lasting impression—turning awareness into
                                            long-term loyalty.
                                        </p>

                                        <ul className="mt-3 p-0">
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Brand Strategy, Positioning &
                                                Identity Development
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Logo Design & Visual Brand
                                                Guidelines
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Consistent Brand Messaging &
                                                Storytelling
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Brand Presence Across Website,
                                                Social Media & Marketing Assets
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Brand Audits & Growth-Focused
                ...
                <section className="seo-plan-section inner_padding">
                    <div className="container">
                        <h2 className="fw-bold text-center">Branding Packages</h2>
                    ...
                    <div className="box">
                        <div className="col-sm-11 col-lg-8 col-xxl-7 mx-auto">
                            <h2 className="mb-5 mx-2">
                                Build a Powerful Identity with <span>Strategic Brand Building</span> That Creates Trust, Recognition & Long-Term Business Value
                            </h2>
                            <Link
                                to="/contact"
