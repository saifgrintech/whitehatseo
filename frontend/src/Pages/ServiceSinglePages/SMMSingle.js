        ...
        const fetchServiceContent = async () => {
            ...
            try {
                const response = await fetch(
                    `${BASE_URL}/single-service/slug/social-media-marketing`
                );
                if (!response.ok) {
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            },
            {
                ...
                item: "https://whitehatseo.in/services/social-media-marketing",
            },
        ],
    };
        ...
        <>
            ...
            <div className="service_single">
                                ...
                                <div className="row align-items-center">
                                    <div className="col-lg-7 position-relative text-start">
                                        <h1 className="hero-title mb-4 text-start">
                                            Result-Driven <span>Social Media Marketing</span> Services That
                                            Build Brands & Drive Engagement
                                        </h1>
                                        ...
                                        <p className="m-0">
                                            ...
                                            (Twitter) to increase engagement, traffic, and conversions. From content
                                            creation and community management to paid social campaigns, we ensure your
                                            brand stays consistent, visible, and impactful—driving measurable growth
                                            with every post.
                                        </p>

                                        <ul className="mt-3 p-0">
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Custom Social Media Strategy &
                                                Content Planning
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Facebook, Instagram, LinkedIn &
                                                X (Twitter) Management
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>High-Engagement Creatives,
                                                Reels & Short-Form Videos
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Paid Social Media Ads for Leads,
                                                Sales & Brand Awareness
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Detailed SMM Reports with
                                                Growth, Reach & Engagement Metrics
                                            </li>
                                        </ul>
                ...
                <section className="seo-plan-section inner_padding">
                    <div className="container">
                        <h2 className="fw-bold text-center">SMM Packages</h2>
               ...
               <section className="ready-to-talk position-relative">
                <div className="box">
                     <div className="col-sm-11 col-lg-8 col-xxl-7 mx-auto">
                        ...
                        Grow Your Brand with <span>Powerful Social Media Marketing</span>
                        <br />
                        That Engages, Converts & Builds Loyal Audiences
                        </h2>
