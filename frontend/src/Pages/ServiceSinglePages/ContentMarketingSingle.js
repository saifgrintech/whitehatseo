    ...
    const fetchServiceContent = async () => {
      ...
      try {
        const response = await fetch(
          `${BASE_URL}/single-service/slug/content-marketing`
        );
        if (!response.ok) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: "https://whitehatseo.in/services/content-marketing",
      },
    ],
  };
    ...
    <>
      ...
      <div className="service_single">
                ...
                <div className="row align-items-center">
                  <div className="col-lg-7 position-relative text-start">
                    <h1 className="hero-title mb-4 text-start">
                      Results-Focused <span>Content Marketing Services</span> That
                    ...
                    <p className="m-0">
                      ...
                      engagement, and conversions. From blog posts and landing pages to website
                      copy and content strategy, we ensure every piece of content supports your
                      SEO goals, strengthens your brand voice, and delivers measurable results.
                    </p>

                    <ul className="mt-3 p-0">
                      <li>
                        <i className="fa-solid fa-check me-2"></i>Content Strategy & Editorial
                        Planning
                      </li>
                      <li>
                        <i className="fa-solid fa-check me-2"></i>SEO-Optimized Blogs, Articles &
                        Website Content
                      </li>
                      <li>
                        <i className="fa-solid fa-check me-2"></i>Content Optimization for Search
                        Intent & Conversions
                      </li>
                      <li>
                        <i className="fa-solid fa-check me-2"></i>Brand Storytelling & Consistent
                        Messaging
                      </li>
                      <li>
                        <i className="fa-solid fa-check me-2"></i>Content Performance Tracking &
                        Growth Reporting
                      </li>
                    </ul>
        ...
        <section className="seo-plan-section inner_padding">
          <div className="container">
            <h2 className="fw-bold text-center">Content Marketing Packages</h2>
            <CommonPlan />
          </div>
        </section>
          ...
          <div className="box">
            <div className="col-sm-11 col-lg-8 col-xxl-7 mx-auto">
              <h2 className="mb-5 mx-2">
                Attract, Engage & Convert with <span>Strategic Content Marketing</span> That Builds Authority, Drives Traffic & Fuels Long-Term Growth
              </h2>
              <Link
                to="/contact"
...
export default ContentMarketingSingle