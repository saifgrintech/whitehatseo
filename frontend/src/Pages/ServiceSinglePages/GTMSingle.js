        ...
        const fetchServiceContent = async () => {
            ...
            try {
                const response = await fetch(
                    `${BASE_URL}/single-service/slug/google-tag-manager-gtm`
                );
                if (!response.ok) {
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            },
            {
                ...
                item: "https://whitehatseo.in/services/google-tag-manager-gtm",
            },
        ],
    };
        ...
        <>
            ...
            <div className="service_single">
                        ...
                        <div className="box">
                            <div className="container">
                                <div className="row align-items-center">
                                    <div className="col-md-6 col-lg-7 position-relative text-start">
                                        <h1 className="hero-title mb-4 text-start">
                                            Advanced <span>Google Tag Manager (GTM)</span> Services For
                                        ...
                                        <p className="m-0">
                                            ...
                                            campaigns. From form submissions and button clicks to e-commerce and
                                            custom events, we ensure your data is clean, reliable, and ready to power
                                            smarter marketing decisions—while maintaining fast load times and
                                            compliance with best practices.
                                        </p>

                                        <ul className="mt-3 p-0">
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Google Tag Manager Setup &
                                                Configuration
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Event, Conversion & Funnel
                                                Tracking Implementation
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>GA4, Google Ads & Meta Pixel
                                                Integration
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>E-commerce & Custom Event
                                                Tracking via Data Layer
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Debugging, Testing & Clean
                                                Reporting Setup
                                            </li>
                                        </ul>
                ...
                <section className="seo-plan-section inner_padding">
                    <div className="container">
                        <h2 className="fw-bold text-center">GTM Packages</h2>
                    ...
                    <div className="box">
                       <div className="col-sm-11 col-lg-8 col-xxl-7 mx-auto">
                         <h2 className="mb-5 mx-2">
                            Gain Complete Data Control with <span>Expert Google Tag Manager Setup</span>  That Tracks Every Click, Conversion & User Interaction Accurately
                        </h2>
