        ...
        const fetchServiceContent = async () => {
            ...
            try {
                const response = await fetch(
                    `${BASE_URL}/single-service/slug/google-my-business-gmb`
                );
                if (!response.ok) {
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            },
            {
                ...
                item: "https://whitehatseo.in/services/google-my-business-gmb",
            },
        ],
    };
        ...
        <>
            ...
            <div className="service_single">
                                ...
                                <div className="row align-items-center">
                                    <div className="col-lg-7 position-relative text-start">
                                        <h1 className="hero-title mb-4 text-start">
                                            Optimized <span>Google My Business (GMB)</span> Services To
                                            Boost Local Visibility & Leads
                                        </h1>
                                        ...
                                        <p className="m-0">
                                            ...
                                            optimization and local keyword targeting to review management and regular
                                            updates, we ensure your business appears credible, active, and trustworthy—
                                            helping you attract more local customers and grow your revenue.
                                        </p>

                                        <ul className="mt-3 p-0">
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Google Business Profile Setup &
                                                Complete Optimization
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Local Keyword Targeting for
                                                Higher GMB Rankings
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Google Maps & “Near Me” Search
                                                Optimization
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Reviews Management & Reputation
                                                Building
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Insights, Calls & Actions
                                                Tracking with Monthly Reports
                                            </li>
                                        </ul>
                ...
                <section className="seo-plan-section inner_padding">
                    <div className="container">
                        <h2 className="fw-bold text-center">GMB Packages</h2>
                    ...
                    <div className="box">
                        <div className="col-sm-11 col-lg-8 col-xxl-7 mx-auto">
                            <h2 className="mb-5 mx-2">
                                Boost Local Visibility with <span>Google My Business Optimization</span> That Drives More Calls, Visits & Qualified Local Leads
                            </h2>
