        ...
        const fetchServiceContent = async () => {
            ...
            try {
                const response = await fetch(
                    `${BASE_URL}/single-service/slug/marketing-research`
                );
                if (!response.ok) {
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            },
            {
                ...
                item: "https://whitehatseo.in/services/marketing-research",
            },
        ],
    };
        ...
        <>
            ...
            <div className="service_single">
                                ...
                                <div className="row align-items-center">
                                    <div className="col-lg-7 position-relative text-start">
                                        <h1 className="hero-title mb-4 text-start">
                                            Insightful <span>Marketing Research Services</span> That Drive
                                        ...
                                        <p className="m-0">
                                            ...
                                            opportunities and optimize marketing campaigns. By combining qualitative
                                            and quantitative research methods, we help you minimize risks, improve
                                            strategies, and maximize ROI—turning insights into measurable results.
                                        </p>

                                        <ul className="mt-3 p-0">
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Market Analysis & Industry
                                                Research
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Competitor Benchmarking &
                                                Strategy Insights
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Target Audience Profiling &
                                                Customer Behavior Analysis
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Marketing Trends & Opportunity
                                                Identification
                                            </li>
                                            <li>
                                                <i className="fa-solid fa-check me-2"></i>Actionable Reports & Strategic
                                                Recommendations
                                            </li>
                                        </ul>
                ...
                <section className="seo-plan-section inner_padding">
                    <div className="container">
                        <h2 className="fw-bold text-center">Marketing Research Packages</h2>
                    ...
                    <div className="box">
                        <div className="col-sm-11 col-lg-8 col-xxl-7 mx-auto">
                            <h2 className="mb-5 mx-2">
                                Make Data-Driven Decisions with <span>Comprehensive Marketing Research</span> That Analyzes Markets, Competitors & Customer Behavior for Growth
                            </h2>
                            <Link
                                to="/contact"
...
export default MarketingResearchSingle