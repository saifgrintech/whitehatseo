                ...
                <div className=" bg-white mt-5 pt-4 ">
                    <div className=" py-3 px-3">
                        <div className="container-fluid d-flex justify-content-between ">
                            ...
                            <Link to='/add-plan' className="btn btn-warning btn-sm">Add New <i className="fa-solid fa-plus"></i> </Link>
                        </div>
                    </div>
                            ...
                            <tbody>
                                {currentBlogs.map((blog, index) => (
                                    <tr key={blog._id}>
                                        ...
                                        <td><div className="table_title">{blog.planName}</div></td>
                                        <td><div className="table_title">{blog.price}</div></td>
                                        <td><div className="table_title">{blog.duration}</div></td>
                                        ...
                                        <td>
                                            <div className="d-flex justify-content-around pt-1">
                                                <Link to={`/edit-plan/${blog._id}`}><i className='fa-solid fa-pencil mx-2 text-warning'></i></Link>
                                                <i
