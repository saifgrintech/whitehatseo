...
const SingleBlogList = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${BASE_URL}/single-blog`);
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`${BASE_URL}/single-blog/${id}`);
                ...
                <div className=" bg-white mt-5 pt-4 ">
                    <div className=" py-3 px-3">
                        <div className="container-fluid d-flex justify-content-between ">
                            <h4 className='mb-0'>All Single Blogs</h4>
                            <Link to='/add-singleblog' className="btn btn-warning btn-sm">Add New <i className="fa-solid fa-plus"></i> </Link>
                        </div>
                    </div>
                                    ...
                                    <tr key={blog._id}>
                                        ...
                                        <td>
                                            <div className="d-flex justify-content-around pt-1">
                                                <Link to={`/edit-singleblog/${blog._id}`}><i className='fa-solid fa-pencil mx-2 text-warning'></i></Link>
                                                <i
