                    ...
                    <div className="bg-white mt-5 pt-4 ">
                        <div className=" py-3 ">
                            <div className="container-fluid d-flex justify-content-between ">
                                <h4 className='mb-0'>All About Us</h4>
                                ...
                                <tbody>
                                    {currentBlogs.map((blog, index) => (
                                        <tr key={blog._id}>
                                            ...
                                            <td>
                                                <img src={`/aboutUs/${blog.image}`} alt={blog.title} style={{ width: '50px' }} />
                                            </td>
                                            ...
                                            <td>
                                                <div className="d-flex justify-content-around pt-1">
                                                    <Link to={`/edit-about/${blog._id}`}><i className='fa-solid fa-pencil mx-2 text-warning'></i></Link>
                                                    <i
