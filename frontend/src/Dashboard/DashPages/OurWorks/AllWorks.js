...
const AllWorks = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${BASE_URL}/work`);
        ...
        <>
            <div className="main_wrapper">
                ...
                <div className="main_content">
                   <DashNav />
                   <div className='all_blogs container-fluid mt-5 mb-5 pb-5'>
                <div className="bg-white pt-4 ">
                    <div className=" py-3 px-3">
                        <div className="container-fluid d-flex justify-content-between ">
                            <h4 className='mb-0'>All Works</h4>
                            <Link to='/addwork' className="btn btn-warning btn-sm">Add Work <i className='fa-solid fa-plus'></i></Link>
                        </div>
                    </div>
                            ...
                            <tbody>
                                {currentBlogs.map((blog, index) => (
                                    <tr key={blog._id}>
                                        <td><b>{index+1}</b></td>
                                        <td>
                                            <img src={`/workimages/${blog.image}`} alt={blog.title} style={{ width: '50px' }} />
                                        </td>
                                        ...
                                        <td>
                                            <div className="d-flex justify-content-around pt-1">
                                                <Link to={`/editwork/${blog._id}`}><i className='fa-solid fa-pencil mx-2 text-warning'></i></Link>
                                                <i
